...
public class TestLivreDaoMemory {
	...
	public void updateTest() {
		Livre livre   = new Livre("Stupeur et tremblements",1999, "AmÈÈÈÈlie Nothomb");
		livre = livreDao.save(livre);
		livre = livreDao.findOne(livre.getId());
		livre.setAuteur("AmÈlie Nothomb");
		livreDao.update(livre);
		Assert.assertEquals("AmÈlie Nothomb", livreDao.findOne(livre.getId()).getAuteur());
